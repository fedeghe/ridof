...
t.states[++t.currentIndex]=e}function n(t,e){this.activeCheck=!!e,this.config=e||{},this.tags=[t],this.size=1}function r(e,s,r){t(e,o.REDUCERS_FUNCTION),this.reducer=e,
...
;return function(n,r,i){n=n||e;var o=Object.assign({},n);for(s in t)o[s]=t[s](o[s],r,i);return o}}const o={REDUCERS_FUNCTION:"[ERROR] Reducer must be a function!",
...
n.listeners=n.listeners.slice(0,s).concat(n.listeners.slice(s+1))}},r.prototype.replaceReducer=function(e){t(e,o.REDUCERS_FUNCTION),this.reducer=e},r.prototype.reset=function(){var t=this.states[0]
